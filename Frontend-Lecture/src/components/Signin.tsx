...
function Signin() {
  ...
  const { register,getValues, handleSubmit } = useForm<User>();
  ...
  function handle(data: FieldValues) {
    ...
    // Add the additional value 'isStudent: true'
    const updatedValues = { ...currentValues, is_lecturer: true };
    ManageUsers.userSign(updatedValues)
      .then(() => {
